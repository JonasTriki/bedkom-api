...
drop table if exists users, authorized_users, dots, companies, menus, food_entries, presentations, organizers, registrations, waitlist;
...
-- Last authorized table
create table last_authorized
(
  id varchar primary key,
  user_id varchar not null
    constraint authorized_users_users_id_fk
      references users(id)
      on delete cascade,
  year char(4) not null,
